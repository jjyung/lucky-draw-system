...
/**
 * User → UserResourceDTO 映射（ADR-012，unmappedTargetPolicy=ERROR）。
 * id/username/email 同名自動映射；roles（Set<Role> → List<RolesEnum>）以 default method 轉換。
...
public interface UserMapper {
    ...
    default UserResourceDTO.RolesEnum toRolesEnum(Role role) {
